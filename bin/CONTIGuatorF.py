...
def WriteMap(ContigsMap,sContig,sRef,oCFs,bMoreOutputs,iNumN,mylog):
    ...
    for cMap in ContigsMap:
        ...
        for cprof in oCFs.profiles:
    		...
    		#print hit.sstart
    		#print cMap.start
    		#if hit.sstart - cMap.start > 100000 :continue
    		#if hit.sstart - cMap.start < 100000 :continue
    		if hit.sstart<20000:continue
    		if hit.sstart > maior :
    		    maior = hit.sstart
    		if hit.sstart < menor :
    		    menor = hit.sstart;
    		...
    		if hit.send < menor :
    		    menor = hit.send
    	feat.qualifiers['note']= str(menor) + "-" + str(maior) + "-> " + fSubjectValueP + ".." + str(menor-1)
    	fSubjectValueP = str(maior+1)
    	# end felipe
